...
const MediaRoomPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <main className="flex-grow bg-primary-dark text-white py-16 relative overflow-hidden" id="media-room-content">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 max-w-2xl mx-auto">
              <div className="p-4 bg-white/[0.01] border border-white/5 rounded-sm flex flex-col items-center text-center">
                ...
                <span className="text-xs font-bold text-secondary-light mt-1">Under Construction</span>
              </div>
              <div className="p-4 bg-white/[0.01] border border-white/5 rounded-sm flex flex-col items-center text-center">
                ...
                <span className="text-xs font-bold text-secondary-light mt-1">Curating Gallery</span>
              </div>
              <div className="p-4 bg-white/[0.01] border border-white/5 rounded-sm flex flex-col items-center text-center">
                ...
                <span className="text-xs font-bold text-secondary-light mt-1">Editing Highlights</span>
              </div>
            </div>
