...
const AdminLoginPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <main className="flex-grow bg-primary-dark text-white py-20 relative overflow-hidden" id="admin-login-content">
        ...
        <div className="institutional-container relative z-10 flex flex-col items-center justify-center">
          ...
          {isSetupNeeded === null ? (
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-secondary-light text-xs uppercase tracking-widest font-black">Initializing secure connection...</p>
            </div>
          ) : (
            <motion.div
              ...
              className="w-full max-w-md bg-white/5 backdrop-blur-md border border-white/10 rounded-sm p-8 sm:p-10 shadow-2xl relative border-t-4 border-secondary overflow-hidden"
            >
              ...
              {isSetupNeeded ? (
                ...
                <>
                  <div className="text-center space-y-3 mb-8">
                    <div className="w-12 h-12 bg-accent/15 border border-secondary/20 text-orange-400 rounded-full flex items-center justify-center mx-auto shadow-lg">
                    ...
                    <p className="text-secondary-light text-xs leading-relaxed max-w-xs mx-auto">
                      {language === 'hi' 
                  ...
                  {status === 'success' ? (
                    ...
                    >
                      ...
                      <p className="text-xs text-secondary-light">Admin configured. Loading login screen...</p>
                    </motion.div>
                  ) : (
                    <form onSubmit={handleSetup} className="space-y-5">
                      ...
                      <div>
                        <label className="block text-[10px] font-black text-secondary-light uppercase tracking-wider mb-2">Admin Email</label>
                        <div className="relative">
                          <input 
                            ...
                            className="w-full pl-10 pr-4 py-3.5 bg-primary-dark/40 border border-white/10 rounded-sm focus:ring-1 focus:ring-orange-500 outline-none text-sm text-white" 
                            placeholder="admin@gurukulam.org" 
                          />
                          <Mail size={16} className="absolute left-3.5 top-4 text-secondary-light/60" />
                        </div>
                      </div>

                      <div>
                        <label className="block text-[10px] font-black text-secondary-light uppercase tracking-wider mb-2">Create Password</label>
                        <div className="relative">
                          <input 
                            required 
                            type="password" 
                            ...
                            placeholder="••••••••" 
                          />
                          <Lock size={16} className="absolute left-3.5 top-4 text-secondary-light/60" />
                        </div>
                      </div>

                      <div>
                        <label className="block text-[10px] font-black text-secondary-light uppercase tracking-wider mb-2">Confirm Password</label>
                        <div className="relative">
                          <input 
                            required 
                            type="password" 
                      ...
                      <button 
                        ...
                        type="submit" 
                        className="w-full bg-accent hover:bg-orange-700 text-white py-4 rounded-sm font-black text-xs uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xl hover:-translate-y-0.5 disabled:opacity-70 disabled:hover:translate-y-0"
                      >
                ...
                <>
                  ...
                  {status === 'success' ? (
                    ...
                    >
                      ...
                      <p className="text-xs text-secondary-light">Loading admin console...</p>
                    </motion.div>
                  ) : (
                    <form onSubmit={handleLogin} className="space-y-6">
                      ...
                      <div>
                        <label className="block text-[10px] font-black text-secondary-light uppercase tracking-wider mb-2">Password</label>
                        <div className="relative">
                          <input 
                            required 
                            type="password" 
