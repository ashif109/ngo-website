...
const HowToReachPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <main className="flex-grow bg-primary-dark text-white py-16 relative overflow-hidden" id="how-to-reach-content">
        ...
        <div className="institutional-container relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20 items-start">
            ...
            <div className="lg:col-span-7 space-y-8">
              {methods.map((method, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="w-12 h-12 rounded-sm bg-accent/10 border border-secondary/20 flex items-center justify-center text-orange-400 flex-shrink-0">
                      <Icon size={22} />
                    </div>
                    <div>
                      <h3 className="font-serif font-black text-base text-white uppercase tracking-wider mb-1.5">{method.title}</h3>
                      <p className="text-xs sm:text-sm text-secondary-light/85 leading-relaxed">{method.desc}</p>
                    </div>
                  </motion.div>
                );
              })}
              ...
              <div className="bg-white/[0.02] border border-white/5 p-6 rounded-sm shadow-md space-y-3">
                ...
                <ul className="list-disc pl-5 text-xs sm:text-sm text-secondary-light/80 space-y-2 leading-relaxed">
            ...
            <div className="lg:col-span-5 space-y-6 bg-white/5 border border-white/10 p-6 sm:p-8 rounded-sm shadow-xl">
              ...
              <div className="w-full h-[280px] bg-primary-dark/40 rounded-sm overflow-hidden border border-white/10 shadow-md">
                <iframe 
              ...
              <div className="pt-2">
                <a 
                  ...
                  className="w-full bg-accent hover:bg-orange-700 text-white py-3.5 rounded-sm font-black text-xs uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-xl hover:-translate-y-0.5"
                >
