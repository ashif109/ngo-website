...
// @desc    Create a page
// @access  Admin/Editor
router.post('/', authenticate, authorize(['super-admin', 'admin', 'content-manager', 'editor']), async (req: any, res: any) => {
  try {
...
// @desc    Update a page
// @access  Admin/Editor
router.put('/:id', authenticate, authorize(['super-admin', 'admin', 'content-manager', 'editor']), async (req: any, res: any) => {
  try {
